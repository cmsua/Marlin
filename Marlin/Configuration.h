...
#define STRING_CONFIG_H_AUTHOR "(Nathan N)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 2560, 2560, 400 } /* = (400 steps/rev * 256 microsteps) / (pitch * teeth) = (400 * 256) / (2 * 20) */
